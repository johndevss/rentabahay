<x-layout>
    <div class="bg-white p-10 rounded-xl shadow-lg border border-gray-200 relative">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-500">Billing Period: <span class="font-semibold text-gray-700">{{ $billing_month }}</span></p>
        </div>

        <div class="space-y-4 mb-8">
            <div class="flex justify-between border-b pb-2">
                <span class="text-gray-600">Base Rent</span>
                <span class="font-medium">PHP {{ number_format($base_rent, 2) }}</span>
            </div>
            
            <div class="flex justify-between border-b pb-2">
                <span class="text-gray-600">Electricity (Meralco)</span>
                <span class="font-medium">PHP {{ number_format($meralco_bill, 2) }}</span>
            </div>
        ...
        <div class="flex justify-between items-center bg-gray-50 p-4 rounded-lg">
            ...
            <span class="text-2xl font-bold text-blue-600">PHP {{ number_format($total_due, 2) }}</span>
        </div>
