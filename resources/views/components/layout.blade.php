...
<body class="h-full text-gray-800 font-sans antialiased selection:bg-blue-500 selection:text-white">
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 print:py-0">
        
        <header class="mb-10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pb-6 border-b border-gray-200/60 print:hidden">
            ...
            <nav class="flex items-center gap-2">
                ...
                <a href="/profile" class="text-xs sm:text-sm font-semibold text-gray-600 hover:text-gray-900 px-4 py-2 rounded-xl hover:bg-gray-100 transition duration-200">
                    Profile
                </a>
